...
| <img src="./Icons/Architecture-Service/Arch_Compute/64/Arch_AWS-Batch_64.png" width="40"> | [**AWS Batch**](https://aws.amazon.com/batch/) | | Fully Managed service to easily run batch processing and distributed computing workloads at any scale.<br><br>Batch jobs are defined as Docker images and run on ECS, EKS, Fargate. |
