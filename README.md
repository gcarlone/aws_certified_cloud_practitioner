...
> Note: some services (e.g., **Amazon Machine Image (AMI)**, **Amazon WorkSpaces Secure Browser**, **AWS Schema Conversion Tool**) have no dedicated icon in the official AWS icon package; the generic icon of their category is used as a placeholder for these entries.
