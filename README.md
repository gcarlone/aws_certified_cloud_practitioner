...
| <img src="./Icons/Architecture-Service/Arch_Compute/64/Arch_AWS-Outposts-family_64.png" width="40"> | [**AWS Outposts Family**](https://aws.amazon.com/outposts/) | | Fully managed service extending AWS infrastructure, native services, and APIs to on-premises environments for a hybrid cloud experience. See also *`AWS Outposts Rack`* and *`AWS Outposts Servers`*. |
...
| <img src="./Icons/Architecture-Service/Arch_Compute/64/Arch_AWS-Elastic-Beanstalk_64.png" width="40"> | [**AWS Elastic Beanstalk**](https://aws.amazon.com/elasticbeanstalk/) | | Platform as a Service (PaaS) to quickly deploy, scale, and manage web applications without handling the underlying infrastructure.<br><br>Architecture models:<ul><li>Single Instance deployment</li><li>LB + ASG (for production web applications)</li><li>ASG (for production non-web applications)</li></ul><br>Offers a full monitoring suite with health metrics pushed in CloudWatch. | 
...
| <img src="./Icons/Architecture-Service/Arch_Databases/64/Arch_Amazon-Neptune_64.png" width="40"> | [**Amazon Neptune**](https://aws.amazon.com/neptune/) | | Fully managed, highly available **graph database** service optimized for rich datasets like social networks and interconnected maps.<br>Can store up to billions of relations and query the graph with millisecond latency. |
...
| <img src="./Icons/Architecture-Service/Arch_Business-Applications/64/Arch_Amazon-Quick_64.png" width="40"> | [**Amazon QuickSight**](https://aws.amazon.com/quicksight/) | | Serverless, machine learning-powered business intelligence service to build interactive dashboards and visualizations.<br>Fast, automatically scalable, embeddable, with per-session pricing.<br>Integrates with RDS, Aurora, Athena, Redshift, and S3 to perform business analytics, ad-hoc analysis, and gain business insights. |
...
| <img src="./Icons/Architecture-Service/Arch_Management-Tools/64/Arch_AWS-Config_64.png" width="40"> | [**AWS Config**](https://aws.amazon.com/config/) | | Evaluates, audits, and records internal resource setups to maintain organization-wide regulatory compliance guidelines.<br><br>**AWS Config Resource:**<ul><li>Compliance of a resource over time</li><li>Configuration of a resource over time</li></ul> |
...
| Icon | Service | Global | Description |
| :---: | :--- | :---: | :--- |
| <img src="./Icons/Architecture-Service/Arch_Application-Integration/64/Arch_Amazon-EventBridge_64.png" width="40"> | [**Amazon EventBridge (CloudWatch Events)**](https://aws.amazon.com/eventbridge/) | | Serverless ***event bus service*** to route, schedule, and react to events generated by AWS services, SaaS applications, and custom code. |
| <img src="./Icons/Architecture-Service/Arch_Application-Integration/64/Arch_Amazon-MQ_64.png" width="40"> | [**Amazon MQ**](https://aws.amazon.com/amazon-mq/) * | | Managed message broker service for **Apache ActiveMQ** and **RabbitMQ**, supporting open protocols (MQTT, AMQP, STOMP, Openwire, WSS) used by traditional on-premises applications.<br>Unlike SQS/SNS, it runs on servers (with Multi-AZ failover) and doesn't scale as much, but combines both queue (~SQS) and topic (~SNS) features, easing migration to the cloud without re-engineering the application. |
...
| <img src="./Icons/Architecture-Service/Arch_Developer-Tools/64/Arch_AWS-CodeArtifact_64.png" width="40"> | [**AWS CodeArtifact**](https://aws.amazon.com/codeartifact/) | | Secure, scalable, and cost-effective artifact management service to store and retrieve software package dependencies. Compatible with common dependency management tools such as Maven, Gradle, npm, yarn, twine, pip, and NuGet — developers and CodeBuild can retrieve dependencies directly from it. |
| <img src="./Icons/Architecture-Service/Arch_Developer-Tools/64/Arch_AWS-CodeBuild_64.png" width="40"> | [**AWS CodeBuild**](https://aws.amazon.com/codebuild/) | | Fully managed build service that compiles source code, runs tests, and produces deployment-ready software packages.<br>Only pay for the build time. |
| <img src="./Icons/Architecture-Service/Arch_Developer-Tools/64/Arch_AWS-CodeCommit_64.png" width="40"> | [**AWS CodeCommit**](https://aws.amazon.com/codecommit/) | | Fully managed source-control service that hosts private, Git-based repositories (AWS' equivalent of GitHub). Makes it easy to collaborate on code, with changes automatically versioned; scalable, highly available, and secured. |
| <img src="./Icons/Architecture-Service/Arch_Developer-Tools/64/Arch_AWS-CodeDeploy_64.png" width="40"> | [**AWS CodeDeploy**](https://aws.amazon.com/codedeploy/) | | Hybrid deployment service that automates application deployments to EC2 instances, on-premises servers, or Lambda. Servers/instances must be provisioned ahead of time with the **CodeDeploy Agent** installed, which pulls and applies the new application revision. |
| <img src="./Icons/Architecture-Service/Arch_Artificial-Intelligence/64/Arch_Amazon-CodeGuru_64.png" width="40"> | [**Amazon CodeGuru**](https://aws.amazon.com/codeguru/) | | ML-powered service for automated code reviews and application performance recommendations, made of two components:<ul><li>**CodeGuru Reviewer** — performs automated static code analysis during development to flag security vulnerabilities, resource leaks, and best-practice violations (Java/Python, integrates with GitHub, Bitbucket, and CodeCommit).</li><li>**CodeGuru Profiler** — analyzes runtime behavior in production to pinpoint the most expensive lines of code, reduce CPU utilization, and lower compute costs, with minimal overhead.</li></ul>Compared to **AWS X-Ray**, which traces requests across distributed/microservice architectures to find latency bottlenecks and errors, CodeGuru Profiler focuses on code-level performance *within* a single application (which functions/lines consume the most CPU/time) rather than *between* services. |
...
| <img src="./Icons/Architecture-Service/Arch_Developer-Tools/64/Arch_AWS-X-Ray_64.png" width="40"> | [**AWS X-Ray**](https://aws.amazon.com/xray/) | | Distributed tracing and debugging service used to visual analyze and troubleshoot performance issues in production applications. Can help to understand dependencies in a microservice architecture. |
...
| <img src="./Icons/Architecture-Service/Arch_Business-Applications/64/Arch_Amazon-Connect_64.png" width="40"> | [**Amazon Connect**](https://aws.amazon.com/connect/) | | Cloud-based, omnichannel virtual contact center service that pairs with `Amazon Lex` for AI-driven speech recognition and chatbot-powered call routing. |
| <img src="./Icons/Architecture-Service/Arch_Artificial-Intelligence/64/Arch_Amazon-Kendra_64.png" width="40"> | [**Amazon Kendra**](https://aws.amazon.com/kendra/) | | Incremental learning enterprise ***document search service*** powered by machine learning to find accurate answers across internal documents. |
...
| <img src="./Icons/Architecture-Service/Arch_Artificial-Intelligence/64/Arch_Amazon-Personalize_64.png" width="40"> | [**Amazon Personalize**](https://aws.amazon.com/personalize/) | | Fully managed machine learning service to build applications with real-time, personalized product recommendations and re-ranking. |
...
| <img src="./Icons/Architecture-Service/Arch_Security-Identity/64/Arch_Amazon-Detective_64.png" width="40"> | [**Amazon Detective**](https://aws.amazon.com/detective/) | | Security service that uses machine learning and graph analysis to investigate and identify the ***root cause*** of security issues or suspicious activities. |
...
| <img src="./Icons/Architecture-Service/Arch_Security-Identity/64/Arch_AWS-Firewall-Manager_64.png" width="40"> | [**AWS Firewall Manager (FMS)**](https://aws.amazon.com/firewall-manager/) | | Central service to manage security rules (Security Groups, WAF, Shield Advanced, Network Firewall) across all accounts of an AWS Organization; rules are automatically applied to new resources and to future accounts as well, which is useful for compliance. |
...
| <img src="./Icons/Architecture-Service/Arch_Security-Identity/64/Arch_AWS-IAM-Identity-Center_64.png" width="40"> | [**AWS IAM Identity Center**](https://aws.amazon.com/iam/identity-center/) | | Single sign-on (SSO) service to centrally manage access across multiple AWS accounts in AWS Organizations. |
| <img src="./Icons/Architecture-Service/Arch_Security-Identity/64/Arch_Amazon-Inspector_64.png" width="40"> | [**Amazon Inspector**](https://aws.amazon.com/inspector/) | | ***Automated security assessment*** service that scans ***ONLY*** EC2 instances, container images, and Lambda functions for vulnerabilities. |
| <img src="./Icons/Architecture-Service/Arch_Security-Identity/64/Arch_AWS-Key-Management-Service_64.png" width="40"> | [**AWS Key Management Service (KMS)**](https://aws.amazon.com/kms/) | | Managed service to create and control cryptographic keys used to encrypt data across AWS services and applications.<br><br>Key types: <ul><li>**Customer managed key** – created and fully controlled by the customer, supports rotation and bring-your-own-key.</li><li>**AWS managed key** – created and managed by AWS on the customer's behalf, used by AWS services (e.g., `aws/s3`).</li><li>**AWS owned key** – owned and managed entirely by AWS across multiple accounts, not visible to the customer.</li><li>**CloudHSM key (custom keystore)** – generated in the customer's own CloudHSM hardware, operations run within the CloudHSM cluster.</li></ul> |
...
| <img src="./Icons/Architecture-Service/Arch_Security-Identity/64/Arch_AWS-Network-Firewall_64.png" width="40"> | [**AWS Network Firewall**](https://aws.amazon.com/network-firewall/) | | Managed network firewall protecting an entire Amazon VPC with Layer 3-7 filtering, inspecting VPC-to-VPC, inbound/outbound internet, and Direct Connect / Site-to-Site VPN traffic in any direction. |
...
| <img src="./Icons/Architecture-Service/Arch_Security-Identity/64/Arch_AWS-WAF_64.png" width="40"> | [**AWS WAF**](https://aws.amazon.com/waf/) | ✓ | Web application firewall that protects web applications and APIs (Layer 7) from common exploits (SQL Injection, XSS, ...) using configurable rules. Define Web Access Control List (ACL). |
